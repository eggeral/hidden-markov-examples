...
fun <TState, TObservation> HiddenMarkovModel<TState, TObservation>.trainOneStepUsingWikipediaBaumWelch(observationsList: List<List<TObservation>>): HiddenMarkovModel<TState, TObservation> {
