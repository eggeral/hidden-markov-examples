...
class ViterbiExample {

    @Test
    fun `the most likely weather sequence can be calculated by observing umbrellas`() {
        ...
        // when
        // we don't know the weather on the first day and the sequence of observations is 'no umbrella' 'umbrella 'umbrella'

        // then
        // the most probable sequence is Foggy, Rainy, Rainy
